(function() {
	...
	tinymce.create('tinymce.plugins.WidgetsPlugin', {
		init : function(ed, url) {
			...
			ed.addCommand('mceInsertForms', function( something, value ) {
				...
				if( typeof(value) === 'undefined' ) {
					...
					ed.execCommand('mceInsertContent', false, '<img src="/share/images/widgets/forms.gif" alt="' + value + '" class="widgetForms mceItemNoResize" title="'+ed.getLang('widgets.forms_widget')+'" />');
				}
			});
			...
			ed.addCommand('mceInsertGalleries', function( something, value ) {
				...
				if( typeof(value) === 'undefined' ) {
					...
					ed.execCommand('mceInsertContent', false, '<img src="/share/images/widgets/galleries.gif" alt="' + value + '" class="widgetGalleries mceItemNoResize" title="'+ed.getLang('widgets.galleries_widget')+'" />');
				}
			});

			ed.addCommand('mceInsertTestimonials', function( ) {

				ed.execCommand('mceInsertContent', false, '<img src="/share/images/widgets/testimonials.gif" class="widgetTestimonials mceItemNoResize" title="'+ed.getLang('widgets.testimonials_widget')+'" />');
			});

			ed.addCommand('mceInsertNews', function( ) {

				ed.execCommand('mceInsertContent', false, '<img src="/share/images/widgets/news.gif" class="widgetNews mceItemNoResize" title="'+ed.getLang('widgets.news_widget')+'" />');
			});

			ed.addCommand('mceInsertEvents', function( ) {

				ed.execCommand('mceInsertContent', false, '<img src="/share/images/widgets/events.gif" class="widget_events mceItemNoResize" title="'+ed.getLang('widgets.events_widget')+'" />');
			});
		...
		_handleMoreBreak : function(ed, url) {
			var formsHTML = '<img class="widgetForms mceItemNoResize" src="/share/images/widgets/forms.gif" alt="$1" title="'+ed.getLang('widgets.forms_widget')+'" />';
			var galleriesHTML = '<img class="widgetGalleries mceItemNoResize" src="/share/images/widgets/galleries.gif" alt="$1" title="'+ed.getLang('widgets.galleries_widget')+'" />';
			var testimonialsHTML = '<img class="widgetTestimonials mceItemNoResize" src="/share/images/widgets/testimonials.gif" title="'+ed.getLang('widgets.testimonials_widget')+'" />';
			var eventsHTML = '<img class="widget_events mceItemNoResize" src="/share/images/widgets/events.gif" title="'+ed.getLang('widgets.events_widget')+'" />';
			var newsHTML = '<img class="widgetNews mceItemNoResize" src="/share/images/widgets/news.gif" title="'+ed.getLang('widgets.news_widget')+'" />';
