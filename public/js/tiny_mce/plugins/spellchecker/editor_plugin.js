...
(function() {
	...
	tinymce.create('tinymce.plugins.SpellcheckerPlugin', {
		...
		init : function(ed, url) {
			...
			// Register commands
			ed.addCommand('mceSpellCheckSilent', function() {
				t._sendRPC('checkWords', [t.selectedLang, t._getWords()], function(r) {
					t._done();
			...
			t.languages = {};
			each(ed.getParam('spellchecker_languages', '+English=en,Welsh=cy,Danish=da,Dutch=nl,Finnish=fi,French=fr,German=de,Italian=it,Polish=pl,Portuguese=pt,Spanish=es,Swedish=sv', 'hash'), function(v, k) {
				if (k.indexOf('+') === 0) {
					k = k.substring(1);
					t.selectedLang = v;
				}
