...
*/
	...
	$index_full_path = realpath( dirname( __FILE__ ) . '/../../public/index.php');
	define('CRON_CI_INDEX', $index_full_path);   // Your CodeIgniter main index.php file
	...
	foreach($argv as $arg)
    {
        ...
        switch($param)
        {
            case '--run':
                ...
                $_SERVER['PATH_INFO'] = $_SERVER['REQUEST_URI'] = $value;
                //$_GET[ $value ] = NULL;
                $required['--run'] = TRUE;
                break;
