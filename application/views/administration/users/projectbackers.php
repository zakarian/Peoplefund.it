...
<div class="mainForm"><fieldset>
	<dl>
		...
		<form id="search-form" method="post" action="/administration/users/project_backers/">
			<dd>
				...
				<label class="short">
					...
					<?php foreach ($letters as $letter): ?>
							...
							<?php else: ?>
									<a href="/administration/<?php echo $current_module?>/project_backers/letter/<?php echo strtoupper($letter) ?>/string/all/"><?php echo strtoupper($letter); ?></a>
							<?php endif; ?>
					<?php endforeach ?>
				</label>
			</dd>
