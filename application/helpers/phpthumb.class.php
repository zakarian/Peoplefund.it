...
//		}
	...
	function ResolveFilenameToAbsolute($filename) {
		...
		if ( !$this->config_allow_src_above_docroot && 
			 ...
			 !preg_match('#^'.preg_quote(str_replace(DIRECTORY_SEPARATOR, '/', realpath($this->config_allowed_src_above_docroot))).'#', $AbsoluteFilename) ) {
			echo preg_quote(str_replace(DIRECTORY_SEPARATOR, '/', realpath($this->config_document_root)));
		...
		if ( !$this->config_allow_src_above_phpthumb && 
			!preg_match('#^'.preg_quote(str_replace(DIRECTORY_SEPARATOR, '/', dirname(__FILE__))).'#', $AbsoluteFilename) &&
			!preg_match('#^'.preg_quote(str_replace(DIRECTORY_SEPARATOR, '/', realpath($this->config_allowed_src_above_docroot))).'#', $AbsoluteFilename) 
			) {
